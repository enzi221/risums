...
0.  IMPORTANT/ALWAYS INCLUDE: Preliminary Protagonist/Partners Privacy Check
    ...
    - Were they in PUBLIC places? Assess carefully - they might have been in PRIVATE blind spots within public places. IF PRIVATE -> UNACCEPTABLE as topics. DO NOT VIOLATE PRIVACY RULES.{{/when}}{{/when}}{{/when}}
...
{{#when::{{getglobalvar::toggle_lb-mini.diversity}}::is::1}}
